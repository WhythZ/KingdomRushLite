...
bool ResourceManager::LoadSoundRes()
{
	...
	soundPool[SoundResID::Player_Dragon_Skill_Impact] = Mix_LoadWAV("Assets/Audios/Sounds/Player_Dragon_Skill_Impact.wav");
	...
	soundPool[SoundResID::Bullet_Arrow_Hit_2] = Mix_LoadWAV("Assets/Audios/Sounds/Bullet_Arrow_Hit_2.mp3");
	soundPool[SoundResID::Bullet_Arrow_Hit_3] = Mix_LoadWAV("Assets/Audios/Sounds/Bullet_Arrow_Hit_3.mp3");

	soundPool[SoundResID::Bullet_Axe_Fire] = Mix_LoadWAV("Assets/Audios/Sounds/Bullet_Axe_Fire.wav");
	soundPool[SoundResID::Bullet_Axe_Hit_1] = Mix_LoadWAV("Assets/Audios/Sounds/Bullet_Axe_Hit_1.mp3");
	soundPool[SoundResID::Bullet_Axe_Hit_2] = Mix_LoadWAV("Assets/Audios/Sounds/Bullet_Axe_Hit_2.mp3");
	soundPool[SoundResID::Bullet_Axe_Hit_3] = Mix_LoadWAV("Assets/Audios/Sounds/Bullet_Axe_Hit_3.mp3");
